...
IMPALA_PKG_VERSION=$(IMPALA_BASE_VERSION)+hdp2.3.0+rocana1.5.0
IMPALA_RELEASE_VERSION=0.rc2
IMPALA_TARBALL_DST=impala-$(IMPALA_BASE_VERSION).tar.gz
IMPALA_TARBALL_SRC=impala-$(IMPALA_BASE_VERSION)-hdp2.3.0-rocana1.5.0-rc2.tar.gz
